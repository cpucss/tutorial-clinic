...
const articles = [
  ...
  { title: "How do I submit study notes?", category: "Notes", body: "Open My Notes, add the title, subject, description, tags, and a supported file. Submit it for administrator review." },
  ...
  { title: "Why is account setup required?", category: "Account", body: "Account setup replaces your temporary password with a secure password that only you know." },
];
