-- Migration: 20260902004500_airtight_notes_storage_and_two_phase_deletion.sql
-- Description: Enforce exact 3-segment storage path validation, strengthen delete policies, and add get_deletable_note_paths RPC.

-- 1. Airtight Storage Upload Policy for tutorial-notes
...
-- 2. Airtight Storage Delete Policy for tutorial-notes
...
-- 3. Create get_deletable_note_paths RPC
